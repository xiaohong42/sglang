...
class TestDsv4TritonSwiglu(unittest.TestCase):
    def test_clamp_before_silu_without_clamping_negative_gate(self):
        ...
        # fused_experts_impl reads get_parallel().tp_group eagerly as an argument
        # to use_symmetric_memory, which resolves through parallel_state and raises
        # before distributed init. get_parallel is what this module imports on main.
        with patch(
            "sglang.srt.layers.moe.moe_runner.triton_utils.fused_moe.get_parallel",
